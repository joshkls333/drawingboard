...
public class DrawingOldBoard implements Serializable
{
...
class DrawingBoardPanel extends JComponent
{
    ...
    private int currentX, currentY, oldX, oldY, currX, currY;
...
//////// method for overriding the MouseReleased event handler ///////////
        ...
        public void mouseReleased(MouseEvent e)
        {
            ...
            if(lineCheck == true && e.getClickCount() == 2)
            {
                ...
                g2.drawLine(xClicks.get(0), yClicks.get(0), xClicks2.get(0), yClicks2.get(0));
                repaint();
                clearClicks();
